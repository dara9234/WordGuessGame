var numberOfRemainingGuesses = 10; //initialize to always 12 from the start
...
var randomWord = ["Aladdin", "Cinderella", "Aurora", "Ariel ", "Belle", "Jasmine", "Pocahontas", "Mulan", "Tiana", "Rapunzel", "Merida", "Anna", "Elsa", "Moana", "Gaston", "Genie", "Goofy", "Kristoff", "Mickey", "Minnie", "Olaf", "Simba", "Winnie"];
...
var wordGame = {
    ...
    resetGame: function () {
            ...
            //   of element of randomWords array from 0 to 23

            //2. call global computerGuessWord assigned with the 
            //   random picked word. Make sure to lowercase it.

            computerGuessWord = randomWord[Math.floor(Math.random() * 23)].toLowerCase();  // combined steps 1 and 2
...
function initialize_Game(){
    ...
    computerGuessWord = randomWord[Math.floor(Math.random() * 23)].toLowerCase();
...
document.onkeyup = function (event) {
    ...
    //     global variable called inputKeypressed to assign with letter variable 
